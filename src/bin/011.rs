...
fn main() {
    ...
    for i in 0..N {
        for j in 0..N {
            let base_index = i * (N - 1) + j;

            // Check horizontal
            if j < N - ADJ {
                let p: u32 = numbers[base_index]
                    * numbers[base_index + 1]
                    * numbers[base_index + 2]
                    * numbers[base_index + 3];
                max = max.max(p);
            }
            ...
            if i < N - ADJ {
                let p: u32 = numbers[base_index]
                    * numbers[base_index + N]
                    * numbers[base_index + 2 * N]
                    * numbers[base_index + 3 * N];
                max = max.max(p);
            }
            ...
            if i < N - ADJ && j < N - ADJ {
                let p: u32 = numbers[base_index]
                    * numbers[base_index + N + 1]
                    * numbers[base_index + 2 * N + 2]
                    * numbers[base_index + 3 * N + 3];
                max = max.max(p);
            }
